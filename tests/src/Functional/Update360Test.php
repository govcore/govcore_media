...
use Drupal\govcore_media\Update\Update360;
use Drupal\user\Entity\Role;
use Prophecy\Argument;
use Symfony\Component\Console\Style\StyleInterface;

/**
 * Tests the optional configuration updates targeting GovCore Media 3.6.0.
 *
 * @group govcore_media
 *
 * @covers \Drupal\govcore_media\Update\Update360
 */
class Update360Test extends UpdatePathTestBase {
  ...
  protected function setUp() {
    ...
    // Install GovCore Roles so we can ensure that content authoring
  ...
  public function test() {
    ...
    // will only work if $this->resetAll() is called when installing GovCore

...
namespace Drupal\govcore_media_bulk_upload\Form;
...
class BulkUploadForm extends FormBase {
   ...
   *
   * @var \Drupal\govcore_media\MediaHelper
   */
  protected $helper;
   ...
   *   The entity type manager.
   * @param \Drupal\govcore_media\MediaHelper $helper
   *   The media helper service.
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('govcore.media_helper'),

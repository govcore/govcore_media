...
namespace Drupal\govcore_media_video\Update;

use Drupal\govcore_core\ConfigHelper;

/**
 * Contains optional updates targeting GovCore Media Video 2.4.0.
 *
 * @Update("2.4.0")
 */
final class Update240 {
  ...
  public function installVideoFileMedia() {
    $helper = ConfigHelper::forModule('govcore_media_video')
      ->optional();

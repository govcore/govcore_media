...
namespace Drupal\govcore_media\Update;
...
/**
 * Contains optional updates targeting GovCore Media 3.6.0.
 *
 * @Update("3.6.0")
 */
final class Update360 implements ContainerInjectionInterface {
  ...
  public static function create(ContainerInterface $container) {
    ...
    if ($container->has('govcore.content_roles')) {
      $arguments[] = $container->get('govcore.content_roles');
    }

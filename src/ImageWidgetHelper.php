...
class ImageWidgetHelper {
  ...
  /**
   * Returns normalized GovCore Media-specific settings for the widget.
   *
  ...
  protected static function getSettings(ImageWidget $widget) {
    $settings = $widget->getThirdPartySettings('govcore_media') ?: [];
  ...
  /**
   * Returns the form for an image widget's GovCore Media-specific settings.
   *
   * @param \Drupal\image\Plugin\Field\FieldWidget\ImageWidget $widget
   *   The widget plugin.
   *
  ...
  /**
   * Summarizes an image widget's GovCore Media-specific settings.
   *
   * @param \Drupal\image\Plugin\Field\FieldWidget\ImageWidget $widget
   *   The widget plugin.
   * @param array $summary

...
namespace Drupal\govcore_media\Form;
...
/**
 * The settings form for controlling GovCore Media's behavior.
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'govcore_media_settings_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('govcore_media.settings')
    ...
    // @see govcore_media_entity_type_alter()
